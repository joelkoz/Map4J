 ...
 *     <li><b>Pixel Space</b> - A "Map Tiling" strategy divides a Web Mercator projected map up into "tiles" that
 ...
 *         is a "2 x 2" matrix of tiles.  Level two is 4 x 4, etc.  Pixel space is usually written as (x, y, z),
 *         which represents the (x,y) coordinate of a position in pixel space at a zoom level of z.</li>
